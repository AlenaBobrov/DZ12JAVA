...
public class TodosTest {
    ...
    public void shouldSearchAll() {
        SimpleTask simpleTask = new SimpleTask(5, "Тест");

        String[] subtasks = {"Тест", "Яйца", "Хлеб"};
        Epic epic = new Epic(55, subtasks);

        Meeting meeting = new Meeting(555, "Тест", "Приложение НетоБанка", "Во вторник после обеда");
